...
export default function BackgroundBeams({ className }: ICommonLayoutProp): ReactNode {
  return (
    <div
      className={cn(
        "z-0 absolute h-full w-full inset-0 [mask-size:40px] [mask-repeat:no-repeat] flex items-center justify-center",
        className
      )}
    >
      <svg
